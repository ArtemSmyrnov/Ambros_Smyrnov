...
namespace WindowsFormsApp1
{
    public partial class _2kartka : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e) //update
        {
            ...
            connection.Open();
            SqlCommand command = new SqlCommand("Update CarRent set CarName = '" + comboBox1.Text + "', DataGive= '" + dateTimePicker1.Text + "', Complectation='" + comboBox2.Text + "' , [DataTake]=getdate() where id ='" + int.Parse(textBox1.Text) + "' ", connection);
        ...
        private void button1_Click(object sender, EventArgs e)  //delete
        {
            ...
            {
                MessageBox.Show("wpisz IDtransaction");
            }
            connection.Close();
            BindData();
